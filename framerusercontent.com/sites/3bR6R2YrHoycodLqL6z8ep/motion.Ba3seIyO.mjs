import { r as e, t } from "./rolldown-runtime.owwqI7_v.mjs";
import {
  A as n,
  B as r,
  C as i,
  ...
  Oe = t(() => {
    ((ee = Object.create),
      ...
      (_e = (e, t, n, r, i) => ({
        ...
        metadata: r,
        addInitializer: (e) =>
          n._ ? oe(`Already initialized`) : i.push(ge(e || null)),
      })),
  ...
  let u = {
    ...
    process: (e) => {
      ...
      ((n = r),
        (r = o),
        n.forEach(l),
        t && B.value && B.value.frameloop[t].push(c),
        (c = 0),
        n.clear(),
        (i = !1),
        a && ((a = !1), u.process(e)));
...
function Le(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = cc.reduce((e, n) => ((e[n] = Ie(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      let a = I.useManualTiming,
        o = a ? i.timestamp : performance.now();
      ((n = !1),
        a ||
          (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, lc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
...
function He(e) {
  return (
    isNaN(e) &&
    typeof e == `string` &&
    (e.match(Sc)?.length || 0) + (e.match(Ic)?.length || 0) > 0
  );
}
function Ue(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          q.test(e)
            ? (r.color.push(a), i.push(Rc), n.push(q.parse(e)))
            : e.startsWith(Bc)
...
function qe(e) {
  let t = Ue(e);
  return Ge(t)(t.values.map((e, n) => Wc(e, t.split[n])));
}
function Je(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function lt({
  ...
  let o = 1 - t;
  ((o = P(X.minDamping, X.maxDamping, o)),
    (e = P(X.minDuration, X.maxDuration, z(e))),
    o < 1
      ? ((i = (t) => {
          let r = t * o,
            i = r * e,
...
function dt(e) {
  ...
  if (!ut(e, nl) && ut(e, tl))
    if (((t.velocity = 0), e.visualDuration)) {
      ...
      t = { ...t, mass: X.mass, stiffness: i, damping: a };
    } else {
...
function ft(e = X.visualDuration, t = X.bounce) {
  let n =
      typeof e == `object`
        ? e
    ...
    } = dt({ ...n, velocity: -z(n.velocity || 0) }),
    m = f || 0,
    h = l / (2 * Math.sqrt(c * u)),
    g = o - a,
    _ = z(Math.sqrt(c / u)),
    v = Math.abs(g) < 5;
  ((r ||= v ? X.restSpeed.granular : X.restSpeed.default),
    (i ||= v ? X.restDelta.granular : X.restDelta.default));
  let y, b, x, S, C, w;
  if (h < 1)
    ((x = st(_, h)),
      (S = (m + h * _ * g) / x),
  ...
  let T = {
    ...
    toString: () => {
      let e = Math.min(at(T), Qc),
        t = Zc((t) => T.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function ht(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Ls(Array.isArray(t) ? t[n] || L : t, a)), r.push(a));
  }
  return r;
}
...
function It(
  ...
  c && (u.offset = c);
  let d = Ft(s, i);
  (Array.isArray(d) && (u.easing = d), B.value && fc.waapi++);
  let f = {
    delay: r,
    duration: i,
...
function Bt(e) {
  typeof e.ease == `string` && zt(e.ease) && (e.ease = Rl[e.ease]);
}
function Vt(e) {
...
function Ht(e) {
  for (let t = 0; t < e.length; t++)
    if (typeof e[t] == `string` && Hl.test(e[t])) return !0;
  return !1;
}
function Ut(e) {
  let {
...
function dn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    if (m.MotionHandoffAnimation) {
      let n = ln(e);
      if (n) {
        let e = m.MotionHandoffAnimation(n, t, V);
        e !== null && ((o.startTime = e), (p = !0));
      }
    }
    sn(e, t);
    let h = l ?? e.shouldReduceMotion;
    r.start(iu(t, r, i, h && au.has(t) ? { type: !1 } : o, e, p));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function vn(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Eu.has(t) && Ue(t).values.length && (i = e[r]),
      r++);
  }
    ...
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(
            e,
            r === m || r === document || n.useGlobalTarget || ju(r, e.target),
          );
        },
        c = (e) => {
          o(e, !1);
        };
      (m.addEventListener(`pointerup`, s, i),
        m.addEventListener(`pointercancel`, c, i));
    };
  return (
    r.forEach((e) => {
...
function Fn() {
  typeof ResizeObserver > `u` || (zu = new ResizeObserver(Pn));
}
function In(e, t) {
  zu || Fn();
  let n = yn(e);
  ...
  return (
    ...
    () => {
      (Uu.delete(e),
        !Uu.size &&
          typeof Wu == `function` &&
          (m.removeEventListener(`resize`, Wu), (Wu = void 0)));
    }
  );
}
function zn(e, t) {
...
function Gn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(Kn(e, s))), V.postRender(u));
    }, c),
    Z(t))
  ) {
...
function Qn(e) {
  return Xn(e.animate) || Qu.some((t) => Zn(e[t]));
}
function $n(e) {
...
function er(e, t, n) {
  for (let r in t) {
    ...
    else if (Z(a)) e.addValue(r, O(i, { owner: e }));
    else if (a !== i)
      if (e.hasValue(r)) {
        let t = e.getValue(r);
...
function Nr(e, t, n, r) {
  for (let n in (wr(e, t, void 0, r), t.attrs))
    e.setAttribute(yd.has(n) ? n : cn(n), t.attrs[n]);
}
function Pr(e, t, n) {
  let r = Or(e, t, n);
  for (let n in e)
...
function Gr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.translate >= kd && e.translate <= Ad) || isNaN(e.translate)) &&
      (e.translate = 0));
}
function Kr(e, t, n, r) {
...
function qr(e, t, n, r = 0) {
  ((e.min = (r ? Y(n.min, n.max, r) : n.min) + t.min), (e.max = e.min + j(t)));
}
function Jr(e, t, n, r) {
...
function Qr(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
    (G.test(t) && ((t = parseFloat(t)), (t = Y(o.min, o.max, t / 100) - o.min)),
    typeof t != `number`)
  )
    return;
...
function ei(e, t, n, r) {
  ($r(e.x, t, jd, n ? n.x : void 0, r ? r.x : void 0),
    $r(e.y, t, Md, n ? n.y : void 0, r ? r.y : void 0));
}
function ti(e) {
...
function ui(e, t, n, r, i, a) {
  i
    ? ((e.opacity = Y(0, n.opacity ?? 1, Ld(r))),
      (e.opacityExit = Y(t.opacity ?? 1, 0, Rd(r))))
    : a && (e.opacity = Y(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let i = 0; i < Pd; i++) {
    let a = Nd[i],
      o = di(t, a),
      s = di(n, a);
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Id(o) === Id(s)
        ? ((e[a] = Math.max(Y(Fd(o), Fd(s), r), 0)),
          (G.test(s) || G.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function vi(e) {
  ...
  if (m.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    m.MotionCancelOptimisedAnimation(n, `transform`, V, !(t || r));
  }
  let { parent: r } = e;
...
function yi({
  ...
  return class {
      ...
      ((this.id = Kd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            B.value &&
              (Ud.nodes =
                Ud.calculatedTargetDeltas =
                Ud.calculatedProjections =
                  0),
            this.nodes.forEach(Si),
            this.nodes.forEach(ji),
            this.nodes.forEach(Mi),
            this.nodes.forEach(Ci),
            B.addProjectionMetrics && B.addProjectionMetrics(Ud));
        }),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Hd.hasAnimatedSinceResize &&
                ((Hd.hasAnimatedSinceResize = !1), this.nodes.forEach(Ai)));
          }));
      }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (m.MotionCancelOptimisedAnimation &&
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      let e = W.now();
      ((U.delta = P(0, 1e3 / 60, e - U.timestamp)),
        (U.timestamp = e),
        (U.isProcessing = !0),
        uc.update.process(U),
        uc.preRender.process(U),
        uc.render.process(U),
        (U.isProcessing = !1));
    }
    didUpdate() {
    ...
    applyTransform(e, t = !1, n) {
      ...
      return (
        lr(this.latestValues) &&
          yr(r, this.latestValues, this.layout?.layoutBox),
        r
      );
    }
    removeTransform(e) {
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          B.value && Ud.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      if (
        ...
        t &&
          ...
          (n = !1),
        this.resolvedRelativeTargetAt === U.timestamp && (n = !1),
        n)
      )
        return;
      let { layout: r, layoutId: i } = this.options;
      ...
      (gr(this.layoutCorrected, this.treeScale, this.path, t),
        e.layout &&
          ...
          ((e.target = e.layout.layoutBox), (e.targetWithTransforms = $())));
      let { target: s } = e;
      if (!s) {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        B.value && Ud.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      let o = $(),
        ...
        u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(Ri));
      this.animationProgress = 0;
      let d;
      ((this.mixTargetDelta = (t) => {
        ...
        (Fi(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            Li(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && ii(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= $()),
            A(d, this.relativeTarget)),
          s &&
    ...
    startAnimation(e) {
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (H(this.pendingAnimation), void 0)),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Gd),
        this.currentAnimation.stop()),
        this.completeAnimation());
    }
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Wd.length; t++)
        (_i(`rotate${Wd[t]}`, e, r, this.animationValues),
          _i(`skew${Wd[t]}`, e, r, this.animationValues));
...
function ra(e) {
  typeof e == `function` && (mf = (t) => (t.startsWith(`on`) ? !na(t) : e(t)));
}
function ia(e, t, n) {
  let r = {};
  for (let i in e)
...
function aa({ children: e, isValidProp: t, ...n }) {
  ...
  return w(ef.Provider, { value: i, children: e });
}
...
function la(e) {
  let { initial: t, animate: n } = ca(e, l(hf));
...
function da(e, t, n) {
  for (let r in t) !Z(t[r]) && !Dr(r, n) && (e[r] = t[r]);
}
...
function ha(e, t, n, r) {
  let i = u(() => {
    let n = yf();
    return (
      Mr(n, t, bd(r), e.transformTemplate, e.style),
...
function ba(e, t, r, i, a, s) {
  ...
  let x = r[fu],
    S = n(
      !!x &&
        m !== void 0 &&
        !m.MotionHandoffIsComplete?.(x) &&
        m.MotionHasOptimisedAnimation?.(x),
    );
  return (
    js(() => {
      ((_.current = !0),
...
function xa(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : Sa(e.parent),
  )),
...
function Ca(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!d && m !== void 0) {
      ...
      let t = Ea(u);
      ((c = t.MeasureLayout),
        (f.visualElement = ba(e, p, u, i, t.ProjectionNode, a)));
    }
    return v(hf.Provider, {
      value: f,
      children: [
        c && f.visualElement
          ? w(c, { visualElement: f.visualElement, ...u })
          : null,
...
function Da(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create`
        ? r
        : (n.has(a) || n.set(a, Ca(a, void 0, e, t)), n.get(a)),
  });
}
function Oa(e) {
...
function Ia(e, t) {
  ...
  let n = e.length - 1,
    r = null,
    i = Fa(e);
  for (; n >= 0 && ((r = e[n]), !(i.timestamp - r.timestamp > R(t))); ) n--;
  if (!r) return { x: 0, y: 0 };
  r === e[0] &&
    e.length > 2 &&
    i.timestamp - r.timestamp > R(t) * 2 &&
    (r = e[1]);
  let a = z(i.timestamp - r.timestamp);
...
function Ha(e, t) {
  ...
  return (
    i > r
      ? (n = Rs(t.min, t.max - r, e.min))
      : r > i && (n = Rs(e.min, e.max - i, t.min)),
    P(0, 1, n)
  );
}
function Ua(e, t) {
...
function eo({ root: e, ...t }) {
  ...
  let r = qf.get(n),
    i = JSON.stringify(t);
  return (
    r[i] || (r[i] = new IntersectionObserver(Yf, { root: e, ...t })),
    r[i]
  );
}
function to(e, t, n) {
...
function io(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > np ? 0 : Bs(i.current - s, l);
}
function ao(e, t, n) {
...
function co(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ...
      : typeof e == `string` &&
        ((e = e.trim()),
        (i = e.includes(` `) ? e.split(` `) : [e, op[e] ? e : `0`])),
    (a = so(i[0], n, r)),
    (o = so(i[1], t)),
    a - o
  );
...
function mo(
  ...
  if ((i.add(a), !up.has(t))) {
    let e = () => {
        for (let e of i) e.measure(U.timestamp);
        V.preUpdate(n);
      },
      n = () => {
    ...
    (m.addEventListener(`resize`, r),
      t !== document.documentElement && dp.set(t, zn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      let r = mp.get(t);
      (r && (H(r), mp.delete(t)), pp.delete(t));
    }
  );
}
function ho(e) {
  return m === void 0 ? !1 : e ? Nl() : Ml();
}
function go(e) {
...
function yo(e) {
  ...
  for (let [t, n] of gp)
    if (vo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function bo(e) {
  let t = { value: 0 };
  return {
...
function Oo(e, t) {
  return m === void 0 ? !1 : e ? Nl() && !!yo(t) : Ml();
}
function ko({ container: e, target: t, ...r } = {}) {
  let i = N(yp);
  Oo(t, r.offset) &&
    ((i.scrollXProgress.accelerate = Do(`x`, r, e, t)),
    (i.scrollYProgress.accelerate = Do(`y`, r, e, t)));
  let a = n(null),
    s = n(!1),
    c = d(
      () => (
    ...
    o(() => {
      ...
      let n,
        r = () => {
          let r = bp(e),
            i = bp(t);
          (F(!r, `Container ref is defined but not hydrated`, `use-scroll-ref`),
            F(!i, `Target ref is defined but not hydrated`, `use-scroll-ref`),
            !r && !i && (n = c()));
        };
      return (
        ku.read(r),
...
function Io(e, t = {}) {
  ...
  if (n) return No(r);
  let i = Ao(r());
  return (T(() => Gn(i, e, t), [i, JSON.stringify(t)]), i);
}
function Lo(e, t = {}) {
...
function Yo(e, t, n, r, i, a) {
  ...
  for (let o = 0; o < t.length; o++)
    e.push({ value: t[o], at: Y(i, a, r[o]), easing: Fe(n, o) });
}
function Xo(e, t, n = 0) {
  let r = t + 1 + t * n;
        ...
        if (
          ...
          i &&
            ...
            h === `reverse` &&
              (o = [...r]
                .reverse()
                .map((e) => (typeof e == `function` ? Ks(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
...
function as(e, t) {
  return Z(e) || typeof e == `number` || (typeof e == `string` && !Wo(t));
}
function os(e, t, n, r) {
  let i = [];
  if (as(e, t)) i.push(pi(e, (Wo(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = Go(e, t, r),
      o = a.length;
...
function ms(e) {
  Qd.current &&
    ((Qd.current.isUpdating = !1), Qd.current.blockUpdate(), e && e());
}
function hs() {
  return d(() => {
    let e = Qd.current;
...
function vs() {
  ...
  return (
    o(() => {
      V.postRender(() =>
        V.postRender(() => {
          t === i.current && (I.instantAnimations = !1);
        }),
      );
    }, [t]),
    (n) => {
      r(() => {
        ((I.instantAnimations = !0), e(), n(), (i.current = t + 1));
      });
    }
  );
}
...
function bs(
  { children: e, as: t = `ul`, axis: r = `y`, onReorder: i, values: a, ...s },
  c,
) {
  let l = N(() => ep[t]),
    u = [],
    d = n(!1),
    f = n(null);
  F(!!a, `Reorder.Group must be provided a values prop`, `reorder-values`);
  let p = {
    axis: r,
    groupRef: f,
    registerItem: (e, t) => {
      let n = u.findIndex((t) => e === t.value);
      (n === -1 ? u.push({ value: e, layout: t[r] }) : (u[n].layout = t[r]),
        u.sort(xs));
    },
    updateOrder: (e, t, n) => {
      if (d.current) return;
  ...
  return w(l, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: w(jp.Provider, { value: p, children: e }),
  });
}
function xs(e, t) {
...
function Ts(e, t, n) {
  let r = t.getBoundingClientRect(),
    ...
    a =
      n === `x`
        ? Math.min(m.innerWidth, r.right)
        : Math.min(m.innerHeight, r.bottom),
    o = e - i,
    s = a - e;
  if (o < Np) {
    let e = 1 - o / Np;
...
function Es(e, t, n, r) {
  ...
  let i = ws(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ts(
    t - (n === `x` ? m.scrollX : m.scrollY),
    i,
    n,
  );
  if (o === null) {
...
function Os(
  ...
  F(!!d, `Reorder.Item must be a child of Reorder.Group`, `reorder-item-child`);
  ...
  return w(u, {
    ...
    onDrag: (e, t) => {
      ...
      (g(n, f[m].get(), r[m]), Es(_.current, a[m], m, r[m]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ss(), a && a(e, t));
    },
...
var ks,
  ...
  Bp = t(() => {
    (E(),
      ...
      (W = {
        now: () => (
          dc === void 0 &&
            W.set(
              U.isProcessing || I.useManualTiming
                ? U.timestamp
                : performance.now(),
            ),
          dc
      ...
      (kc = { test: wc(`#`), parse: Ve, transform: Oc.transform }),
      (Ac = (e) => ({
        test: (t) =>
      ...
      (q = {
        ...
        parse: (e) =>
          Oc.test(e) ? Oc.parse(e) : Fc.test(e) ? Fc.parse(e) : kc.parse(e),
        transform: (e) =>
          typeof e == `string`
            ? e
      ...
      (Uc = (e) =>
        typeof e == `number` ? 0 : q.test(e) ? q.getAnimatableNone(e) : e),
      (Wc = (e, t) =>
        typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Uc(e)),
      (J = {
        test: He,
        parse: We,
      ...
      (al = (e) => {
        ...
        return {
          ...
          stop: () => H(t),
          now: () => (U.isProcessing ? U.timestamp : W.now()),
        };
      }),
      (ol = { decay: mt, inertia: mt, tween: xt, keyframes: xt, spring: ft }),
      (sl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ll = class extends sl {
        constructor(e) {
          (super(),
            ...
            (this.stop = () => {
              ...
              (e && e.updatedAt !== W.now() && this.tick(W.now()),
                (this.isStopped = !0),
                this.state !== `idle` &&
        ...
        initAnimation() {
          ...
          s !== xt &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Ls(cl, it(o[0], o[1]))), (o = [0, 100]));
        ...
        set speed(e) {
          ...
          (t && this.driver && this.updateTime(W.now()),
            (this.playbackSpeed = e),
            t && this.driver && (this.time = z(this.currentTime)));
        }
        play() {
      ...
      (kl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Tl.add(this),
                El || ((El = !0), V.read(jt), V.resolveKeyframes(At)))
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = Pt(() => m.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = Pt(() => m.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = Pt(() => {
        try {
          document
            .createElement(`div`)
      ...
      (Ll = class extends sl {
        ...
        set time(e) {
          ...
          ((this.manualStartTime = null),
            (this.finishedTime = null),
            (this.animation.currentTime = R(e)),
      ...
      (Bl = class extends Ll {
        ...
        updateMotionValue(e) {
          ...
          let o = new ll({ ...a, autoplay: !1 }),
            s = Math.max(zl, W.now() - this.startTime),
            c = P(0, zl, s - zl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Nt(i, u, l),
      ...
      (Wl = Me(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Gl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (ql = class extends sl {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          Gt(e, i, a, o) ||
            ((u = !1),
            (I.instantAnimations || !s) && l?.(St(e, n, t)),
            (e[0] = e[e.length - 1]),
            Vt(n),
            (n.repeat = 0));
          let d = {
      ...
      (iu =
        ...
        (o) => {
          ...
          (Qt(s) || Object.assign(u, nu(e, u)),
            (u.duration &&= R(u.duration)),
            (u.repeatDelay &&= R(u.repeatDelay)),
      ...
      (Du = class extends kl {
        ...
        readKeyframes() {
          ...
          if ((this.resolveNoneKeyframes(), !au.has(n) || e.length !== 2))
            return;
          let [r, i] = e,
            a = hu(r),
            o = hu(i);
      ...
      ({ schedule: ku, cancel: Au } = Le(queueMicrotask, !1)),
      (Q = { x: !1, y: !1 }),
      ...
      (id = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (ed.current || tr(), (this.shouldReduceMotion = $u.current)),
        ...
        bindToMotionValue(e, t) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            i;
          (m !== void 0 &&
            m.MotionCheckAppearSync &&
            (i = m.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (r(), i && i());
            }));
        }
        ...
        getValue(e, t) {
          ...
          return (
            n === void 0 &&
              t !== void 0 &&
              ((n = O(t === null ? void 0 : t, { owner: this })),
              this.addValue(e, n)),
            n
          );
        }
          ...
          return (
            n != null &&
              (typeof n == `string` && (Ps(n) || Is(n))
                ? (n = parseFloat(n))
                : !Ku(n) && J.test(t) && (n = gn(e, t)),
              this.setBaseTarget(e, Z(n) ? n.get() : n)),
            Z(n) ? n.get() : n
          );
        }
        setBaseTarget(e, t) {
      ...
      (md = class extends ad {
        ...
        readValueFromInstance(e, t) {
          if (bl.has(t))
            return this.projection?.isProjecting ? Et(t) : vl(e, t);
          {
            let n = kr(e),
      ...
      (xd = class extends ad {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = yd.has(t) ? t : cn(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Pr(e, t, n);
        }
      ...
      (Jd = (e) =>
        r !== void 0 && r.userAgent && r.userAgent.toLowerCase().includes(e)),
      (Yd = Jd(`applewebkit/`) && !Jd(`chrome/`) ? Math.round : L),
      (Xd = yi({
      ...
      ($d = yi({
        ...
        defaultParent: () => {
          if (!Qd.current) {
            let e = new Xd({});
            (e.mount(m), e.setOptions({ layoutScroll: !0 }), (Qd.current = e));
          }
          return Qd.current;
        },
        resetTransform: (e, t) => {
      ...
      (nf = ({
        ...
        return (
          ...
          w(Ms.Provider, { value: h, children: e })
        );
      }),
      (rf = (e) => e.key || ``),
      (af = ({
        ...
        if (g !== C) {
          ...
          return (o === `wait` && D.length && (e = D), ee(Xi(e)), T(g), null);
        }
        let { forceRender: te } = l(ks);
        return w(x, {
          children: E.map((e) => {
            let n = rf(e),
              c = s && !m ? !1 : g === E || _.includes(n);
            return w(
              nf,
              {
                isPresent: c,
                ...
                onExitComplete: c
                  ...
                  : () => {
                      ...
                      if (b.has(n)) (S.current.add(n), b.set(n, !0));
                      else return;
                      let e = !0;
                      (b.forEach((t) => {
                        t || (e = !1);
                      }),
                        e && (te?.(), ee(y.current), s && h?.(), i && i()));
                    },
                anchorX: d,
                anchorY: f,
                children: e,
      ...
      (lf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (cf(r) && d && (t = t ? d + `-` + t : d),
          (c.current = { id: t, group: (sf(r) && i.group) || Ui() }));
        let f = u(() => ({ ...c.current, forceRender: o }), [s]);
        return w(ks.Provider, { value: f, children: e });
      }),
      (uf = f({ strict: !1 })),
      (df = {
        animation: [
    ...
    ((hf = f({})),
      ...
      (xf = gf({ scrapeMotionValuesFromProps: Or, createRenderState: vf })),
      (Sf = gf({ scrapeMotionValuesFromProps: Pr, createRenderState: yf })),
      ...
      (Of = (e) => (t) => Mu(t) && e(t, Oa(t))),
      (kf = (e, t) => Math.abs(e - t)),
      (Af = (e, t) =>
        (t.isSVG ?? ga(e))
          ? new xd(t)
          : new md(t, { allowProjection: e !== s })),
        ...
        constructor(
          ...
          (u && u(e, Na(s, this.history)),
            (this.removeListeners = Ls(
              ka(this.contextWindow, `pointermove`, this.handlePointerMove),
              ka(this.contextWindow, `pointerup`, this.handlePointerUp),
              ka(this.contextWindow, `pointercancel`, this.handlePointerUp),
            )),
      ...
      (If = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (
            ...
            n.start(iu(e, n, 0, t, this.visualElement, !1))
          );
        }
        stopAnimation() {
      ...
      (zf = class extends od {
        ...
        mount() {
          this.removePointerDownListener = ka(
            this.node.current,
            `pointerdown`,
      ...
      (Hf = {
        pan: { Feature: zf },
        drag: { Feature: Lf, ProjectionNode: $d, MeasureLayout: Za },
      }),
      (Uf = class extends od {
        mount() {
      ...
      (Zf = class extends od {
        ...
        startObserver() {
          ...
          this.stopObserver = to(this.node.current, a, (e) => {
      ...
      ($f = { layout: { ProjectionNode: $d, MeasureLayout: Za } }),
      (ep = Da({ ...Df, ...Qf, ...Hf, ...$f }, Af)),
      ...
      (pp = new WeakMap()),
      (mp = new WeakMap()),
      (hp = (e) => (e === document.scrollingElement ? m : e)),
      (gp = [
        [cp.Enter, `entry`],
        [cp.Exit, `exit`],
        [cp.Any, `cover`],
...
//# sourceMappingURL=motion.Ba3seIyO.mjs.map
